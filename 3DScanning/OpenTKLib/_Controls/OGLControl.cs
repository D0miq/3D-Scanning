...
namespace OpenTKLib
{
    public class OGLControl : OpenTK.GLControl
    {
        ...
        {
            timeAnimation += (double)DateTime.Now.Millisecond;


            this.GLrender.RotationForAnimation = new Vector3d(animationAngle, animationAngle, 0f);


            this.Refresh();

            //GL.UniformMatrix4d(modelviewMatrixLocation, false, ref MV);
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            //if (e.KeyCode == Keys.S)
            //{
            //    this.GLrender.Camera.CenterOfInterest += (double)this.GLrender.Camera.zFar * 0.002f * this.GLrender.Camera.X;
            //    this.GLrender.Camera.Position += (double)this.GLrender.Camera.zFar * 0.002f * this.GLrender.Camera.X;
            //    flag = true;
            //}
            //if (e.KeyCode == Keys.A)
            //{
            //    this.GLrender.Camera.CenterOfInterest -= (double)this.GLrender.Camera.zFar * 0.001f * this.GLrender.Camera.Z;
            //    this.GLrender.Camera.Position -= (double)this.GLrender.Camera.zFar * 0.001f * this.GLrender.Camera.Z;
            //    flag = true;
            //}
            //if (e.KeyCode == Keys.D)
            //{
            ...
            //    flag = true;
            //}
            //double num1 = Convert.ToSingle(Math.Cos(0.01f));
            //double num2 = Convert.ToSingle(Math.Sin(0.01f));
            //if (e.KeyCode == Keys.NumPad4)
            //{
            //    Vector3d vector1 = new Vector3d(this.GLrender.Camera.X);
            //    Vector3d vector2 = new Vector3d(this.GLrender.Camera.Z);
            ...
            //{
            //    Vector3d vector1 = new Vector3d(this.GLrender.Camera.X);
            //    Vector3d vector2 = new Vector3d(this.GLrender.Camera.Y);
            //    this.GLrender.Camera.X = num1 * vector1 + num2 * vector2;
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            if (animationAngle > double.MaxValue)
                animationAngle = 0f;
        ...
        public Matrix4d CalculateRegistrationMatrix1_2()
        {
            ...
            if (this.GLrender.RenderableObjects.Count > 1)
            {
                ...
                myMatrix = SVD.FindTransformationMatrix(v.ArrayVector3ToList(pc1.Vectors), v.ArrayVector3ToList(pc2.Vectors), ICP_VersionUsed.Scaling_Umeyama);
